...
from stores.views import StoresListView, NewItemCreateView, StoreDetailView, StoreUpdateView, StoreDeleteView
...
urlpatterns = [
    ...
    path('new_item/', NewItemCreateView.as_view(), name='new_item'),
